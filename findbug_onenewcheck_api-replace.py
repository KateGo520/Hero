...
import pymysql
# from check_200.update_bug import find_local_use

# from find_local_use import get_local_use
# from findchange_api import get_version, get_go_mod_detail, judge_repo_type
...
def check_go_mod_detail(main_mod_name, sub_mod_path, imp_siv, v_siv, go_mod_url, headers):
    ...
    if imp_siv:
        ...
        if int(v_siv) >= 2:
            module_version_path = 'github.com/' + main_mod_name + sub_mod_path + '/' + v_siv
...
def check_bug_new_repo(fullname, go_mod_url, bug_type_num, bug_list, break_type_num, break_list, replace_num,
                    ...
                    if result > 0:
                        ...
                        if int(v_siv) >= 2 and path_match == 2:
                            if repo_name not in replaces_list:
                                ...
                                (r, issue) = get_local_use(fullname, modle_name, '2-1', time_w, issue)
                                if r == 0:
